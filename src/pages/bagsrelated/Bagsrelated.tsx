...
import { CardButton, CardButton1, CardDiv, CardTypo, CardTypo1, CardTypo2, CardTypo3, CarouselBox, StyleTypo, StyleTypo1, StyleTypo2, TypoProducts, TypographyAmt, TypographyAmt1 } from './Bagsrelated.styled'
